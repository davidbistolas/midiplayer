...
class MidiEvent:
    ...
    def is_end(self):
        ...
        return self._status == END_OF_TRACK
...
class MidiTrack:
    ...
    def _file_data_generator( self ):
        ...
        # DCB- quick hack to fix FILE NOT FOUND errors: 
        with open( self._midifile.filename.strip("//"), "rb") as file:
